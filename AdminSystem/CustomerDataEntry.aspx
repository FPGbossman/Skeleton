...
<body style="height: 294px">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblCustomerFirstname" runat="server" Text="CustomerFirstname "></asp:Label>
        ...
        <br />
        <br />
        <asp:Button ID="Confirm" runat="server" Text="Login" Width="75px" OnClick="Confirm_Click1" style="height: 26px" />
